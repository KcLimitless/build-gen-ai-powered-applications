...
import os
from worker import speech_to_text, text_to_speech, watsonx_process_message, openai_process_message
...
def process_message_route():
    ...
    watsonx_response_text = watsonx_process_message(user_message, target_lang)
    #watsonx_response_text = openai_process_message(user_message, target_lang)
    ...
    #watsonx_response_speech = azure_text_to_speech(watsonx_response_text, voice)
